...
9. For pipe characters (|) in text, write them directly without escaping them"""
    ...
    def prepare_retriever(self, repo_url_or_path: str, type: str = "github", access_token: str = None,
        ...
        save_repo_dir = repo_url_or_path.replace('databases', 'repos').replace('.pkl', '')
        save_db_file = repo_url_or_path

        self.db_manager.repo_paths = {
            "save_repo_dir": save_repo_dir,
            "save_db_file": save_db_file,
        }
        self.db_manager.repo_url_or_path = repo_url_or_path

        self.transformed_docs = self.db_manager.prepare_db_index(
